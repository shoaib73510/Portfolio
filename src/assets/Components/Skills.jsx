...
function Skills() {
  return (
    <div className="container-fluid py-4 tap ">
      ...
      <div className="container rounded p-2">
        <div className="row d-flex justify-content-between">
          {/* Left Column */}
          <div className="col-12 col-md-6 mb-4 d-flex flex-wrap justify-content-evenly">
          ...
          {/* Right Column */}
          <div className="col-12 col-md-6 d-flex flex-wrap justify-content-evenly">
            <div className="card skill-card">
              <div className="card-body d-flex align-items-center">
